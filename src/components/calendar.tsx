          ...
          <div className="sm:hidden">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center gap-1.5 flex-shrink-0 ml-2">
                <button
                  onClick={goToToday}
                  className="flex items-center gap-1 text-[10px] text-amber-900 hover:text-amber-800 font-bold bg-white/80 backdrop-blur-sm px-2.5 py-1.5 rounded-md shadow-sm hover:shadow-md transition-all duration-200 hover:bg-white active:scale-95"
                >
                  <svg
                    className="w-3 h-3"
                    fill="none"
                ...
                {canManage && (
                  <button
                    ...
                    className="flex items-center gap-1 text-[10px] text-gray-700 hover:text-gray-900 font-semibold bg-white/80 backdrop-blur-sm px-2.5 py-1.5 rounded-md shadow-sm hover:shadow-md transition-all duration-200 hover:bg-white active:scale-95"
