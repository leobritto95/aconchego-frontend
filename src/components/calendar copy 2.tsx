      ...
      <div className="w-full mx-auto overflow-x-auto">
        {/* <div className="flex flex-col md:flex-row max-md:gap-3 items-center justify-between mb-5">
          <div className="flex items-center gap-4">
            ...
            <h6 className="text-x leading-8 font-semibold text-gray-900">
              Today, January 2024
            </h6>
          </div>
          <button className="py-1.5 pr-5 pl-4 bg-indigo-600 rounded-xl flex items-center gap-2 text-base font-semibold text-white transition-all duration-300 hover:bg-indigo-700">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
        ...
        <div className=" relative">
          ...
          <div className="hidden grid-cols-7 sm:grid w-full overflow-x-auto">
            ...
            <div className="p-0.5 md:p-3.5   border-t border-r border-gray-200 transition-all hover:bg-stone-100"></div>
            <div className="p-0.5 md:p-3.5   border-t border-r border-gray-200 transition-all hover:bg-stone-100"></div>
            <div className="p-0.5 md:p-3.5   border-t border-r border-gray-200 transition-all hover:bg-stone-100">
            ...
            <div className="p-0.5 md:p-3.5   border-t border-r border-gray-200 transition-all hover:bg-stone-100"></div>
            <div className="p-0.5 md:p-3.5   border-t  border-gray-200 transition-all hover:bg-stone-100"></div>
            ...
            <div className="p-0.5 md:p-3.5   border-t border-r border-gray-200 transition-all hover:bg-stone-100"></div>
            <div className="p-0.5 md:p-3.5   border-t border-r border-gray-200 transition-all hover:bg-stone-100"></div>
            <div className="p-0.5 md:p-3.5   border-t border-gray-200 transition-all hover:bg-stone-100">
              <div className="rounded p-1.5 border-l-2 border-purple-600 bg-purple-50">
                <p className="text-xs font-normal text-gray-900 mb-px">
          ...
          <div className="flex sm:hidden border-t border-gray-200 items-center w-full">
            <div className="flex flex-col">
              <div className="p-2 flex items-end text-xs font-semibold text-gray-400 border-b border-r border-gray-200">
                07:00 am
              </div>
              <div className="p-2 flex items-end text-xs font-semibold text-gray-400 border-b border-r border-gray-200">
                08:00 am
            ...
            <div className="grid grid-cols-2 w-full">
              <div className="w-full border-b border-gray-200 p-1.5">
                <div className="rounded p-1.5 border-l-2 border-purple-600 bg-purple-50">
                  <p className="text-xs font-normal text-gray-900 mb-px">
                    Pickup the grandmother
                  </p>
              ...
              <div className="w-full border-b border-gray-200 p-1.5"></div>
              <div className="w-full border-b border-gray-200 p-1.5"></div>
              <div className="w-full border-b border-gray-200 p-1.5"></div>
              <div className="w-full border-b border-gray-200 p-1.5"></div>
              <div className="w-full border-b border-gray-200 p-1.5">
